...
export const doubleANumber = (number) => number * 2;
console.log(doubleANumber(2)); // 4s
...
export const calculateTheLenghtOfAString2 = (str) => {
...
export const numbersArrayIntoString = (array) => {
...
export const addNewLanguage = (object, newLanguage) => {
...
export const votersResult = (data) =>
  data.reduce(
    (acc, cur) => {
      if (cur.age < 30) {
